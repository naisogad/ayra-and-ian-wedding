  ...
  return (
    <section id='themeM' className='min-h-[600px] pt-[12rem] pr-[0.5rem] pb-[4rem] relative justify-center flex flex-wrap box-border lg:hidden md:hidden'>
        ...
        <div className='absolute top-0 left-0 z-0 box-border block'>
            <h2 className='text-moss -rotate-90 absolute m-0 whitespace-nowrap text-ellipsis z-0 pb-[0.5rem] top-[22rem] left-[-4rem] overflow-auto text-[4rem] leading-[0.9]'>Theme</h2>
        </div>
        {/* CONTENT */}
