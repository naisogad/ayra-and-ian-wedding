  ...
  return (
    <section className='mb-0 pr-0 h-auto pt-0 min-h-[92vh] pb-[3.5rem] relative ml-0 mr-0 mt-15 justify-center flex flex-wrap box-border lg:hidden md:hidden'>
        ...
        <div className='bg-[left_0.5rem] top-[5rem] h-auto min-h-[100vh] z-1 pr-0 pl-0 relative w-full box-border block'>
            {/* HEADER 1 */}
            <div className='left-[2rem] relative mb-[92px] w-[100%] text-right box-border block h-auto min-h-[20rem] motion-preset-slide-left motion-duration-1000'>
                {/* IMAGE 1 */}
            ...
            {/* IMAGE 2 */}
            <div className='left-[2rem] text-right w-[80%] max-w-[100%] h-[0%] relative ml-auto box-border block break-words min-h-[25%] align-middle motion-preset-slide-left motion-duration-1000'>
                <Image 
                    alt=''
