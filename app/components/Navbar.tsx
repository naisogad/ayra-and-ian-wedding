  ...
  return (
    <nav>
      <div className='block top-0 right-0 z-2'>
        {/* MENU BUTTON*/}
        <h4 className='hidden md:block sticky rotate-90 top-[4rem] right-[0rem] z-3 cursor-pointer text-3xl uppercase text-moss' onClick={toggleNav}>Menu</h4>
        {/* MOBILE BUTTON */}
        <button className='space-y-1 fixed top-[2%] right-[3%] z-3 box-border block md:hidden' onClick={toggleNav}>
